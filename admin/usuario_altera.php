...
if (isset($_POST['alterar'])&& $_POST['alterar'] === 'altera_usuario' ) {
  ...
  if (mysqli_query($con,$sql)) {
    $sqlsenha = "UPDATE senhas_tb SET id_usuario='$id_usuario', senha='$senha' WHERE id_usuario=$id_usuario";
  ...
  ?>
    ...
    <div class="col-md-12 col-lg-8">
        ...
        <form class="needs-validation" method="POST" action="" novalidate>
          ...
          <button class="w-100 btn btn-dark btn-lg mb-5" type="submit">Alterar Usuário</button>
        </form>
      </div>
    </main>
  </div>
